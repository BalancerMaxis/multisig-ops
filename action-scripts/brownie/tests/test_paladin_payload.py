...
def test_paladin_merkle_proof_parsing():
    ...
    for value, param_type, expected in test_cases:
        ...
        assert len(result) == len(expected), f"Expected {len(expected)} elements, got {len(result)}"
...
def test_paladin_payload_full():
    ...
    assert parsed_inputs["merkleProof"][0] == "0xea1452517ef03ca99824d4d9fe0a5dc56a205798e139865c9265ec2336b2cbad"
...
def test_edge_cases():
    ...
    assert parse_contract_input("[ '0x123' , '0x456' ]", "bytes32[]") == ["0x123", "0x456"]

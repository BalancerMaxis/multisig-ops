...
PoolRecoveryHelper=Contract.from_explorer("0xf7D5DcE55E6D47852F054697BAB6A1B48A00ddbd")
...
ProtocolFeesPercentagesProvider = Contract.from_explorer("0x1802953277FD955f9a254B80Aa0582f193cF1d77")
...
roleList = roleList.split(", ")
tx = Authorizer.grantRoles(roleList, ProtocolFeesPercentagesProvider.address, {'from': daomsig})
tx.call_trace(expand=True)
...
### 303A
tx = ProtocolFeesPercentagesProvider.setFeeTypePercentage(0, 500000000000000000, {'from': daomsig})
tx.call_trace(expand=True)

tx = ProtocolFeesPercentagesProvider.setFeeTypePercentage(2, 500000000000000000, {'from': daomsig})
tx.call_trace(expand=True)
...
tx = L2BalancerPseudoMinter.addGaugeFactory("0x2498A2B0d6462d2260EAC50aE1C3e03F4829BA95", {'from': daomsig})
tx.call_trace(expand=True)
...
tx = vault.setAuthorizer("0x8df317a729fcaA260306d7de28888932cb579b88", {'from': daomsig})
tx.call_trace(expand=True)
tx = Authorizer.revokeRoles(roleList, daomsig, {'from': daomsig})
tx.call_trace(expand=True)